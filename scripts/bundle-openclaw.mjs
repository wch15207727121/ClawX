...
// 4b. Collect extra packages required by runjianClaw's Electron main process that are
          ...
          try {
            ...
            if (!original.includes('exports.LRUCache')) {
              const patched = [
                original,
                '',
                '// runjianClaw patch: add LRUCache named export for Node.js 22+ ESM interop',
