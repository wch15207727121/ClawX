...
if /i "%1"=="update" (
    echo openclaw is managed by runjianClaw ^(bundled version^).
    echo.
    echo To update openclaw, update runjianClaw:
    echo   Open runjianClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=runjianClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\runjianClaw.exe" "%OPENCLAW_ENTRY%" %*
)
