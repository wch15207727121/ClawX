 ...
 * "openrouter.ai" carries the runjianClaw app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__runjianClawFetchPatched) return;
  globalThis.__runjianClawFetchPatched = true;

  globalThis.fetch = function runjianClawFetch(input, init) {
    var url =
